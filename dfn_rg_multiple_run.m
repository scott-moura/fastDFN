...
% name_data{1} = {'UDDSx2_14I_RG'};
% name_data{2} = {'US06x3_14I_RG'};
% name_data{3} = {'SC04x4_14I_RG'};
% name_data{4} = {'LA92x2_14I_RG'};
% name_data{5} = {'DC1_14I_RG'};
% name_data{6} = {'DC2_14I_RG'};
% 
name_data{1} = {'UDDSx2_10I_VO_Vmax40'};
name_data{2} = {'US06x3_10I_VO_Vmax40'};
name_data{3} = {'SC04x4_14I_VO_Vmax40'};
name_data{4} = {'LA92x2_14I_VO_Vmax40'};
name_data{5} = {'DC1_14I_VO_Vmax40'};
name_data{6} = {'DC2_14I_VO_Vmax40'};
% 
% name_data{1} = {'UDDSx2_12I_VO_Vmax40'};
% name_data{2} = {'US06x3_12I_VO_Vmax40'};
% name_data{3} = {'SC04x4_12I_VO_Vmax40'};
% name_data{4} = {'LA92x2_12I_VO_Vmax40'};
% name_data{5} = {'DC1_12I_VO_Vmax40'};
% name_data{6} = {'DC2_12I_VO_Vmax40'};

experimental_data{1} = {'data/UDDSx2_batt_ObsData.mat'};
experimental_data{2} = {'data/US06x3_batt_ObsData.mat'};
experimental_data{3} = {'data/SC04x4_batt_ObsData.mat'};
experimental_data{4} = {'data/LA92x2_batt_ObsData.mat'};
experimental_data{5} = {'data/DC1_batt_ObsData.mat'};
experimental_data{6} = {'data/DC2_batt_ObsData.mat'};
% Experimental Data
load(char(experimental_data{rr}))
