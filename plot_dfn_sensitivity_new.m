...
params = {'$D_s^{^{\_}}$','$D_s^+$','$R_s^-$','$R_s^+$','$\epsilon_s^{^{\_}}$','$\epsilon_s^+$',...
    '$1/\sigma^{^{\_}}$','$1/\sigma^+$','$D_e$','$\epsilon_e^{^{\_}}$','$\epsilon_e^{sep}$','$\epsilon_e^+$',...
    '$\kappa$','$(1+t^{+}_{0})(1+\frac{d \ln f_{c/a}}{d \ln c_e})$','$k^{^{\_}}$','$k^+$',...
...
% Load Sensitivities
fn= 'data/sensitivity/sensitivity_1C.mat';
load(fn);
